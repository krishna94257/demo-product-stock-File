            ...
            <div class="p-20">
                ...
                <form class="form-horizontal" role="form"  enctype="multipart/form-data" action="<?php echo base_url("product/product_add"); ?>" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-12 col-sm-2 col-form-label"> HSN Code</label>

                        <div class="col-12 col-sm-10">

                            <input type="text" class="form-control" placeholder="HSN CODE " value="<?php echo isset($details->hsn) ? set_value("hsn", $details->hsn) : set_value("hsn"); ?>" id="hsn" name="hsn">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-12 col-sm-2 col-form-label"> CODE 1</label>
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-12 col-sm-2 col-form-label"> CODE 2</label>
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-12 col-sm-2 col-form-label"> SIZE </label>

                        <div class="col-12 col-sm-8">
                               
                            <div class="col-8 col-sm-8" style="float:left;">
                         ...
                         <div style="float:left;">
                              <a href="<?php echo base_url("product/category_list"); ?>" >Add New Category</a>
                          </div>
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-12 col-sm-2 col-form-label"> PRICE</label>
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-12 col-sm-2 col-form-label"> STOCK </label>
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-12 col-sm-2 col-form-label"> DESCRIPTION </label>
