...
-->
                                            ...
                                            <td><?php echo ucfirst($book->product_name);?></td>

                                            <td><?php echo $book->product_id;?></td>

                                            <td><?php echo $book->product_id2;?></td>

                                            <td><?php echo idToName4($book->product_categorie);?></td>
                                            ...
                                            <td class="actions">
                                                ...
                                                <a href="<?php echo base_url("product/product_add/$book->id");?>" class="on-default edit-row" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="fa fa-pencil"></i></a>
